<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:57:"C:\wamp\www\tp5mini/application/admin\view\user\edit.html";i:1471616307;s:59:"C:\wamp\www\tp5mini/application/admin\view\common\head.html";i:1476343053;s:61:"C:\wamp\www\tp5mini/application/admin\view\common\header.html";i:1476343016;s:61:"C:\wamp\www\tp5mini/application/admin\view\common\navbar.html";i:1471616305;s:61:"C:\wamp\www\tp5mini/application/admin\view\common\footer.html";i:1476343167;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo url('admin/user/edit'); ?>">个人</a></li>
        <li class="active"><a href="<?php echo url('admin/user/edit'); ?>">个人资料</a></li>
      </ol>
    </section>
        ...
        <div class="col-md-12">
          <div class="box box-primary">
            ...
            <div class="box-body no-padding">
              <form role="form" id="edit" action="<?php echo url('user/edit'); ?>" method="post">
                <div class="box-body">
                  <div class="form-group">
                    <label for="exampleInputEmail1">昵称</label>
                    <input class="form-control" name="nickname" value="<?php echo $userInfo['nickname']; ?>" placeholder="用户昵称" type="text">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1">邮箱</label>
                    <input class="form-control" name="email" value="<?php echo $userInfo['email']; ?>" placeholder="邮箱" type="text">
                  </div>
                  
                  <div class="form-group">
                    <label for="exampleInputPassword1">手机号</label>
                    <input class="form-control" name="mobile" placeholder="手机号" value="<?php echo $userInfo['mobile']; ?>" type="text">
                  </div>
