<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:63:"C:\wamp\www\tp5mini/application/admin\view\navigation\edit.html";i:1471616306;s:59:"C:\wamp\www\tp5mini/application/admin\view\common\head.html";i:1476343053;s:61:"C:\wamp\www\tp5mini/application/admin\view\common\header.html";i:1476343016;s:61:"C:\wamp\www\tp5mini/application/admin\view\common\navbar.html";i:1471616305;s:61:"C:\wamp\www\tp5mini/application/admin\view\common\footer.html";i:1476343167;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box box-primary">
            ...
            <div class="box-body">
              <!-- Font Awesome Icons -->
              <form  action="<?php echo url('edit'); ?>" method="post" id="edit">
                <div class="form-group">
                  <label for="exampleInputEmail1">名称 </label>
                  <input type="text" class="form-control" value="<?php echo $navigationInfo['name']; ?>" name="name" placeholder="用于前台显示的标题" />
                </div>
                <div class="form-group">
                  <label for="exampleInputPassword1">图标 </label>
                  <input type="text" class="form-control" value="<?php echo $navigationInfo['icon']; ?>" name="icon" placeholder="导航图标" />
                </div>
                <div class="form-group">
                  <label for="exampleInputPassword1">链接</label>
                  <input type="text" class="form-control" value="<?php echo $navigationInfo['url']; ?>" name="url" placeholder="url函数解析的URL或者外链" />
                </div>
                <div class="form-group">
                  <label for="exampleInputPassword1">排序</label>
                  <input type="text" class="form-control" value="<?php echo $navigationInfo['sort']; ?>" name="sort" placeholder="用于分组显示的顺序">
                </div>
                <div class="form-group">
                  <label for="exampleInputPassword1">上级菜单</label>
                  <select class="form-control pidSelect" name="pid">
                   <option value="0">无</option>
                   <?php echo tree_to_nav_select($navigationTree); ?>
                 </select>
                </div>
               <div class="form-group">
                ...
                <input type="hidden" class="form-control" id="id" value="<?php echo $navigationInfo['id']; ?>" name="id"  />
            </form>
            </div>
            <!-- /.box-body -->
            <div class="box-footer">
...
<script>
 $().ready(function (argument) {
    ...
    // 设置select选中
    $(".pidSelect").val("<?php echo $navigationInfo['pid']; ?>");
    $(".hideSelect").val("<?php echo $navigationInfo['hide']; ?>");
 });
</script>
<!-- Bootstrap 3.3.6 -->
