            ...
            foreach ($fields as $key => $value) {
                if ($data) {
                    if (isset($data[$value['name']])) {
                        $formhandle = call_user_func_array(array(new Form,$value['type']), array($value['title'],$value['option'],$data[$value['name']],$value['name'],$value['placeholder'])); 
                    } else {
                        $formhandle = call_user_func_array(array(new Form,$value['type']), array($value['title'],$value['option'],$value['data'],$value['name'],$value['placeholder'])); 
                    }
                } else {
                    $formhandle = call_user_func_array(array(new Form,$value['type']), array($value['title'],$value['option'],$value['data'],$value['name'],$value['placeholder']));
                }
