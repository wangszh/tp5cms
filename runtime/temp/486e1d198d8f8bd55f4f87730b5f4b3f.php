            ...
            <div class="box-body no-padding">
              <form method="post" action=<?php echo url('add'); ?> id="add">
                ...
                <div class="form-group">
                    <label for="uid" class="uname">用户ID</label>
                    <input class="form-control" id="uid" name="uid" value="" placeholder="用户ID" type="text">
  ...
  $.widget.bridge('uibutton', $.ui.button);
    ...
    $('.submit').click(function () {
        $.ajax({
          cache: true,
          type: "POST",
           url: '<?php echo url('Authmanager/addUser'); ?>',
          data: $('#add').serialize(),
          async: false,
