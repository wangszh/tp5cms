<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:56:"C:\wamp\www\tp5mini/application/admin\view\page\add.html";i:1472628371;s:59:"C:\wamp\www\tp5mini/application/admin\view\common\head.html";i:1474875000;s:61:"C:\wamp\www\tp5mini/application/admin\view\common\header.html";i:1474875135;s:61:"C:\wamp\www\tp5mini/application/admin\view\common\navbar.html";i:1471616305;s:61:"C:\wamp\www\tp5mini/application/admin\view\common\footer.html";i:1474879114;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="#">页面</a></li>
        <li class="active"><a href="#">新增页面</a></li>
      </ol>
    </section>
          ...
          <div class="box box-solid">
            ...
            <div class="box-body no-padding">
              <div class="box-body">
                ...
                <div class="form-group">
                <label>排序</label>
                  <input type="text" value='0' name="level" class="form-control">
                </div>
                <div class="form-group">
                <label>别名</label>
                ...
                <div class="form-group">
                <label>page页模板</label>
                  <input type="text" name="page_tpl" class="form-control">
                </div>
              </div>
              <!-- /.box-body -->
              <div class="box-footer">
