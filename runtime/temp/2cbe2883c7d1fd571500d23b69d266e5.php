<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:58:"C:\wamp\www\tp5mini/application/admin\view\post\index.html";i:1472697505;s:59:"C:\wamp\www\tp5mini/application/admin\view\common\head.html";i:1476343053;s:61:"C:\wamp\www\tp5mini/application/admin\view\common\header.html";i:1476343016;s:61:"C:\wamp\www\tp5mini/application/admin\view\common\navbar.html";i:1471616305;s:61:"C:\wamp\www\tp5mini/application/admin\view\common\footer.html";i:1476343167;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
        ...
        <div class="col-md-12">
          <div class="box box-primary">
            <div class="box-header with-border">
              ...
              <div class="pull-left" style="margin-left:15px;">
                <a href="<?php echo url('add'); ?>" class="btn btn-block btn-primary btn-sm">写文章</a>
              </div>
              <div class="box-tools pull-right">
                <div class="has-feedback">
                  <input class="form-control input-sm search" value="<?php echo isset($_GET['q']) ? $_GET['q'] :  ''; ?>" placeholder="搜索文章标题" type="text">
            ...
            <div class="box-body no-padding">
              <div class="table-responsive mailbox-messages">
                <table class="table table-hover table-striped">
                  ...
                  <tbody>
                  <?php if(is_array($postsList) || $postsList instanceof \think\Collection): $i = 0; $__LIST__ = $postsList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                    <tr>
                      <td><input name="ids" class="postCheck" value="<?php echo $vo['id']; ?>" type="checkbox"></td>
                      <td><a href="<?php echo url('post/edit',['id'=>$vo['id']]); ?>"><?php echo $vo['title']; ?></a></td>
                      <td><a href="<?php echo url('post/edit',['id'=>$vo['id']]); ?>"><?php echo get_userinfo($vo['uid'],'username'); ?></a></td>
                      <td><a href="<?php echo url('post/edit',['id'=>$vo['id']]); ?>"><?php echo get_posts_terms($vo['id'],'category'); ?></a></td>
                      <td><a href="<?php echo url('post/edit',['id'=>$vo['id']]); ?>"><?php echo get_posts_terms($vo['id'],'tag'); ?></a></td>
                      <td><a href="<?php echo url('post/edit',['id'=>$vo['id']]); ?>"><?php echo get_posts_status($vo['status']); ?></a></td>
