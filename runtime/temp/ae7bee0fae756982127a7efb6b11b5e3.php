<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:58:"C:\wamp\www\tp5mini/application/admin\view\page\index.html";i:1473045537;s:59:"C:\wamp\www\tp5mini/application/admin\view\common\head.html";i:1474875000;s:61:"C:\wamp\www\tp5mini/application/admin\view\common\header.html";i:1474875135;s:61:"C:\wamp\www\tp5mini/application/admin\view\common\navbar.html";i:1471616305;s:61:"C:\wamp\www\tp5mini/application/admin\view\common\footer.html";i:1474879114;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo url('admin/page/index'); ?>">页面</a></li>
        <li class="active"><a>所有页面</a></li>
      </ol>
    </section>
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              ...
              <div class="pull-left" style="margin-left:15px;">
                <a href="<?php echo url('add'); ?>" class="btn btn-block btn-primary btn-sm">添加页面</a>
              </div>
            ...
            <div class="box-body no-padding">
              <div class="table-responsive mailbox-messages">
                <table class="table table-hover table-striped">
                  ...
                  <tbody>
                        <?php echo tree_to_page_view($postsListTree); ?>
                  </tbody>
                  <thead>
                  <tr>
                    <th><input type="checkbox" class="selectAll"></th>
