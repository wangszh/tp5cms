<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:57:"C:\wamp\www\tp5mini/application/admin\view\page\edit.html";i:1472628371;s:59:"C:\wamp\www\tp5mini/application/admin\view\common\head.html";i:1474875000;s:61:"C:\wamp\www\tp5mini/application/admin\view\common\header.html";i:1474875135;s:61:"C:\wamp\www\tp5mini/application/admin\view\common\navbar.html";i:1471616305;s:61:"C:\wamp\www\tp5mini/application/admin\view\common\footer.html";i:1474879114;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
              ...
              <div class="box-body">
                ...
                <label>父级</label>
                  <select class="form-control pidSelect" name="pid">
                   ...
                   <?php echo tree_to_page_select($postsListTree); ?>
                 </select>
                </div>
                <div class="form-group">
                <label>排序</label>
                  <input type="text" value="<?php echo $postsInfo['level']; ?>" name="level" class="form-control">
                </div>
                <div class="form-group">
                <label>别名</label>
                  <input type="text" value="<?php echo $postsInfo['name']; ?>" name="name" class="form-control">
                </div>
                <div class="form-group">
                <label>page页模板</label>
                  <input type="text" value="<?php echo $page_tpl; ?>" name="page_tpl" class="form-control">
                </div>
              </div>
              <!-- /.box-body -->
              <div class="box-footer">
...
<script type="text/javascript">
  $().ready(function () {
    ...
    // 设置select选中
    $(".pidSelect").val("<?php echo $postsInfo['pid']; ?>");
