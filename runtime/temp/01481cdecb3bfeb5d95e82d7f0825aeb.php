<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:59:"C:\wamp\www\tp5mini/application/admin\view\goods\index.html";i:1472697505;s:59:"C:\wamp\www\tp5mini/application/admin\view\common\head.html";i:1474875000;s:61:"C:\wamp\www\tp5mini/application/admin\view\common\header.html";i:1474875135;s:61:"C:\wamp\www\tp5mini/application/admin\view\common\navbar.html";i:1471616305;s:61:"C:\wamp\www\tp5mini/application/admin\view\common\footer.html";i:1474879114;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
                ...
                <table class="table table-hover table-striped">
                  ...
                  <?php if(is_array($goodsList) || $goodsList instanceof \think\Collection): $i = 0; $__LIST__ = $goodsList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                    <tr>
                      ...
                      <td><a href="<?php echo url('goodsEdit',['id'=>$vo['id']]); ?>"><?php echo $vo['name']; ?></a></td>
                      <td><a href="<?php echo url('goodsEdit',['id'=>$vo['id']]); ?>"><?php echo $vo['price']; ?></a></td>
                      <td><a href="<?php echo url('goodsEdit',['id'=>$vo['id']]); ?>"><?php echo $vo['num']; ?></a></td>
                      <td><a href="<?php echo url('goodsEdit',['id'=>$vo['id']]); ?>"><?php echo $vo['catename']; ?></a></td>
                      <td>
                        <a href="<?php echo url('goodsEdit',['id'=>$vo['id']]); ?>">
                          <?php if($vo['status'] == '1'): ?>
                          已上架
                          <?php else: ?>
                          已下架
